...
public class Camera {
    ...
    private boolean isMeteringAreaAFSupported() {
        return true; //mCameraInfo.get(CameraCharacteristics.CONTROL_MAX_REGIONS_AF) >= 1;
    }
    ...
    public void open(@NonNull final Result result) throws CameraAccessException {
        ...
        //TODO: should check if flash/autoofocus/auto exposure is enabled here
